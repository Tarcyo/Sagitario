...
class ProfessorScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      Center(child: Text('Tela de inscrições', style: _screenTextStyle));
}
...
class DashboardScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      Center(child: Text('Tela de Dashboard', style: _screenTextStyle));
}
...
class HelpScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      Center(child: Text('Ajuda Screen', style: _screenTextStyle));
}
...
class _TelaDoSideBarState extends State<TelaDoSideBar> {
  ...
  final List<String> _labels = ['Registro', 'Inscrição', 'Local', 'Painel'];
