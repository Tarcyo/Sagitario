...
class _TelaDeRegistroState extends State<TelaDeRegistro> {
  ...
  String get _baseUrl => 'https://final-ifg-backend.onrender.com/discipline';
  ...
  String get _usersUrl => 'https://final-ifg-backend.onrender.com/user';
  ...
  Future<void> _fetchClassrooms() async {
    ...
    final token = Provider.of<AuthProvider>(context, listen: false).token;
    final url = Uri.parse('https://final-ifg-backend.onrender.com/classroom');
    try {
  ...
  Future<void> _deleteClassroom() async {
    ...
    if (id.isEmpty) return;
    final token = Provider.of<AuthProvider>(context, listen: false).token;
    final url = Uri.parse('https://final-ifg-backend.onrender.com/classroom/$id');
  ...
  Future<void> _linkClassroomToDiscipline() async {
    ...
    try {
      final token = Provider.of<AuthProvider>(context, listen: false).token;
      final url = Uri.parse(
        'https://final-ifg-backend.onrender.com/discipline/$disciplineId/classroom/$classroomId',
      );
      final res = await http.post(
        url,
        headers: {
