...
import 'package:sagitario/servi%C3%A7os/checkAluno.dart';
import 'package:sagitario/servi%C3%A7os/checkProfessor.dart';
import 'package:sagitario/servi%C3%A7os/getDisciplina.dart';
import 'package:sagitario/servi%C3%A7os/getSalaDeAula.dart';
import 'package:sagitario/servi%C3%A7os/getUser.dart';
      ...
      //    print(
       ...
       //   print("Usuário" + user.toString());
          ...
          if (user.type == 'teacher') {
            ...
            print("Tupla: "+(double.parse(salaDeAula.latitude), double.parse(salaDeAula.longitude), pos.latitude, pos.longitude, salaDeAula.minDistance).toString());
            final estaNoLoocal  = estaNoLocal(double.parse(salaDeAula.latitude), double.parse(salaDeAula.longitude), pos.latitude, pos.longitude, salaDeAula.minDistance);
